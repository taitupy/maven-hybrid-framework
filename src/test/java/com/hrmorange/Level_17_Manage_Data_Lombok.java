...
public class Level_17_Manage_Data_Lombok extends BaseTest {
...
//    private String admin, employee, username, password;
    ...
    public void beforeClass(String browserName){
        ...
        // Tao data test
        userLombok.setUsername("Admin");
        userLombok.setAdmin("Admin");
        userLombok.setEmployee("");
        userLombok.setPassword("admin123");
    }
    ...
    public void User_01_Login(Method method){
        dashboardPage = homePage.systemLogin(userLombok.getUsername(), userLombok.getPassword()); // Page A: HomePage
    ...
    public void User_02_Admin(Method method) {
        ...
        adminPage.adminSearchPage(userLombok.getAdmin(), userLombok.getEmployee());
