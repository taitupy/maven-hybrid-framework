...
public class Level_01_Register_DRY {
	...
	public void TC_02_Register_Invalid_Email() {
		...
		driver.findElement(By.cssSelector("input#Password")).sendKeys("Automation@12345");
		driver.findElement(By.cssSelector("input#ConfirmPassword")).sendKeys("Automation@12345");
		driver.findElement(By.cssSelector("button#register-button")).click();
