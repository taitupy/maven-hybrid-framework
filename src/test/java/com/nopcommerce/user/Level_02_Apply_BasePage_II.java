...
public class Level_02_Apply_BasePage_II {
	...
	public void TC_01_Register_Empty_Data() {
		basePage.waitForElementClickabe(driver, "//a[@class='ico-register']");
		basePage.clickToElement(driver, "//a[@class='ico-register']");
		
		basePage.waitForElementClickabe(driver, "//button[@id='register-button']");
	...
	public void TC_02_Register_Invalid_Email() {
		...
		basePage.sendkeyToElement(driver, "//input[@id='Password']", "Automation@12345");
		basePage.sendkeyToElement(driver, "//input[@id='ConfirmPassword']", "Automation@12345");
	...
	public void TC_03_Register_Success() {
		...
		basePage.waitForElementClickabe(driver, "//a[@class='ico-logout']");
